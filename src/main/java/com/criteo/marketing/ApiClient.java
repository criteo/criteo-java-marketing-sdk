...
import com.criteo.marketing.auth.Authentication;
import com.criteo.marketing.auth.HttpBasicAuth;
import com.criteo.marketing.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.criteo.com/marketing";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.criteo.com/marketing
    ...
    private void refreshTokenIfNotValid() throws ApiException {
        if (tokenInfo == null || !tokenInfo.isValid()) {
            ...
            InlineResponse200 response = (new AuthenticationApi(this)).oAuth2TokenPost(
            ...
            this.setApiKeyPrefix(response.getTokenType());
