...
```groovy
compile "com.criteo:marketing.java-client:1.0.0"
```
...
* `target/marketing.java-client-1.0.0.jar`
* `target/lib/*.jar`
...
import com.criteo.marketing.*;
import com.criteo.marketing.auth.*;
import com.criteo.marketing.model.*;
